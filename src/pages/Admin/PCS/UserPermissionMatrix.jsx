...
const UserPermissionMatrix = () => {
  ...
  const getPermissionStatus = (user, pagePath) => {
    ...
    const rolePermissions = {
      ...
      'FinishedGoodsStoreManager': ['/dashboard', '/finished-goods/inventory', '/finished-goods/storage-locations', '/finished-goods/claim-dispatches', '/finished-goods/add-products-pricing'],
