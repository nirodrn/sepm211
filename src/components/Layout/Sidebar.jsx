...
import { Home, Users, Package, Truck as TruckIcon, FileText, BarChart3, Settings, ShoppingCart, Clipboard, Archive, Factory, Package2, Send, Eye, Database, Receipt, CheckCircle, Clock, TrendingUp, Crown, ClipboardCheck, Plus, Warehouse, MapPin, Shield, Smartphone, DollarSign, AlertTriangle, Store } from 'lucide-react';
  ...
  const getMenuItems = () => {
    ...
    if (hasRole('Admin')) {
      return [
        ...
        {
          title: 'Direct Showrooms',
          icon: Store,
          path: '/admin/direct-showrooms',
          roles: ['Admin', 'MainDirector']
        },
        {
